document.addEventListener("DOMContentLoaded", function() {
    ...
    aboutMeBox.addEventListener('click', function(event) {
        ...
        if (!aboutMeBox.classList.contains('expanded')) {
            ...
            Rodrigo Couto Catarino, who holds a degree in Graphic and Multimedia Design from the Professional School of Arts and Design at Caldas da Rainha, graduated in 2024, has been pursuing his passion for design since 2017. Constantly seeking knowledge, he believes that learning is never too much and carries this philosophy into all his projects, unafraid to take risks for the sake of evolution.
